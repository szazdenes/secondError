...
# Template: app
# Command: /home/denes/Qt/5.5/gcc_64/bin/qmake -spec linux-g++ CONFIG+=debug -o Makefile 2ndStepSorter.pro
#############################################################################
...
SOURCES       = main.cpp \
		secodstepsorter.cpp moc/moc_secodstepsorter.cpp
OBJECTS       = obj/main.o \
...
DIST          = ../../../../Qt/5.5/gcc_64/mkspecs/features/spec_pre.prf \
		...
		2ndStepSorter.pro secodstepsorter.h main.cpp \
		secodstepsorter.cpp
...
Makefile: 2ndStepSorter.pro ../../../../Qt/5.5/gcc_64/mkspecs/linux-g++/qmake.conf ../../../../Qt/5.5/gcc_64/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec linux-g++ CONFIG+=debug -o Makefile 2ndStepSorter.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents secodstepsorter.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp secodstepsorter.cpp $(DISTDIR)/
...
compiler_rcc_clean:
compiler_moc_header_make_all: moc/moc_secodstepsorter.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc/moc_secodstepsorter.cpp
